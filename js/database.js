...
answersAndQuestions = {
    'work': {
        1: {'question': 'Расскажите о себе',
            'answer': `Меня зовут Виктор, мне 34 года. Я разработчик с опытом более трех лет, основной стек в последнее время это пайтон, фастапи, постгрес, так же, раньше на проектах использовал Django, успешно использовал рэдис
                        из брокеров сообщений настраивал рэбит, пишу тесты, владею gitlab ci/cd, Grafana, Sentry, Docker, Jenkins. Работал как с монолитом так и с микросервисной архитектурой.</br>
        ...
        2: {'question': 'Почему вы ищете новую работу?',
            'answer': `В первую очередь я гонюсь за развитием профессиональных навыков, поэтому ищу проект в котором буду использовать новые технологии
                       ...
                       `},
        3: {'question': 'Расскажите о самом интересном своём проекте',
        ...
        7: {'question': 'Опишите как был устроен рабочий процесс на последнем месте работы',
            'answer': `Работаем по канбану. Задачи берем сами в Jira из колонки (ready for dev). Когда только пришёл, то задачи мне давал тимлид. Можно было брать максимум 3 задачи в разработку в один момент.<br>
                        ...
                        `},
        8: {'question': 'Какие ваши ожидания от нового места работы?',
        ...
        10: {'question': 'ЛЕГЕНДА, ВОПРОСЫ О ТЕКУЩЕМ МЕСТЕ РАБОТЫ - не технические',
            'answer': `
        ...
        11: {'question': 'Опишите самую интересную задачу с которой сталкивались',
            'answer': `Нужно было автоматизировать процесс формирования сложного отчета и отправки его результатов с определенной периодичностью, передо мной стояла задача разработать и запустить крон, документации не было
                        ...
                        дергал из кэша, а новые (начиная с установленной отметки) запрашивал из постри, но их было не много. Таким образом крон стал работать быстрее и меньше нагружать основную БД`},
        ...
        14: {'question': 'Расскажите о ситуации, когда вы не укладывались в сроки',
            'answer': `Считаю что такие ситуации нормальны в нашей работе. Часто приходиться работать с задачами высокой неопределенности и тут главное держать в курсе команду и заинтересованные стороны.
                        ...
                        `},
        15: {'question': 'ЛЕГЕНДА, ВОПРОСЫ О ТЕКУЩЕМ МЕСТЕ РАБОТЫ - технические',
    ...
    'python': {
        ...
        12: {'question': 'Что такое декораторы в Python? Как написать свой декоратор?',
            'answer': 'Особый вид функций, которые позволяют изменить/дополнить функционал другой функции, не изменяя её исходный код..'},
        ...
        14: {'question': 'Что делает функция enumerate?',
            'answer': `Предоставляет лёгкий способ перебирать элементы итерируемого объекта вместе с их индексами,<br/>
                        возвращает кортежи содержащие индекс и элемент`},
...
<br>
<strong>Uniform interface</strong> = единство интерфейса - все данные должны запрашиваться через один URL-адрес, стандартными протоколами. рест полагается на протокол http и его запросы гет, пост и тд. это упрощает архитектуру сайта или приложения и делает взаимодействие понятнее.<br>
<br>
